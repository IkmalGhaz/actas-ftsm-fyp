...
// Guna pool (bukan createConnection) supaya sambungan yang ditutup oleh MySQL
// akibat wait_timeout (tidak aktif) tidak menyebabkan proses crash — pool
// membuka semula sambungan secara telus pada setiap db.query().
